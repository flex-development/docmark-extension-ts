...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/docmark-extension-ts
   cd docmark-extension-ts
   ```
...
```sh
https://github.com/flex-development/docmark-extension-ts/compare/main...$branch
```
